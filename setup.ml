...
(* OASIS_START *)
(* DO NOT EDIT (digest: da33f4b07e80178e5c713a8c821ca683) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_semver", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "test_semver.ml"});
               Test
                 ({
                     cs_name = "test_semver";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "κό%d\130.\019UZ\1428\021κ\157\006®";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
